...
def change_number_to_color(nubmer:int)->str:
    if number = 0:
        return 'R'
    elif number = 1:
        return 'O'
...
##            print('row',jewel_col_position)
##            print('col',jewel_col_position)
        if board[jewel_col_position][jewel_row_position-1] == None:
            return True
...
##            print('index',index)
##            print('if_jewel_on_board_after_move_down',jewel.check_if_jewel_on_board_after_move_down(game_state))
            if jewel.check_if_jewel_on_board_after_move_down(game_state) == True:
##                print('jewel.check_if_jewel_on_board',jewel.check_if_jewel_on_board(game_state))
                if jewel.check_if_jewel_on_board(game_state) == True:
